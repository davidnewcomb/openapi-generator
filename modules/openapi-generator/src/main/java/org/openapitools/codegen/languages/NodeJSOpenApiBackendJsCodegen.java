...
public class NodeJSOpenApiBackendJsCodegen extends DefaultCodegen implements CodegenConfig {

    public static final String EXPORTED_NAME = "exportedName";
    public static final String SERVER_HOST = "serverHost";
    public static final String SERVER_PORT = "serverPort";

    private static final Logger LOGGER = LoggerFactory.getLogger(NodeJSOpenApiBackendJsCodegen.class);
    private static final String PROJ = "nodejs-openapibackendjs";
    ...
    public NodeJSOpenApiBackendJsCodegen() {
        super();
        ...
        outputFolder = "generated-code/" + PROJ;
        embeddedTemplateDir = templateDir = PROJ;
...
//        modelTemplateFiles.clear();
        ...
        apiTemplateFiles.put("index.mustache", ".js");

        supportingFiles.add(new SupportingFile("openapi.mustache", "api", "openapi.yaml"));
        supportingFiles.add(new SupportingFile("index.mustache", "", "index-sup.js"));
        ...
        supportingFiles.add(new SupportingFile("HandlerBase.mustache", "controllers", "HandlerBase.js"));
    }
    ...
    public String getHelp() {
        return "Generates a NodeJS OpenApiBackend module (beta). IMPORTANT: this generator may subject to breaking changes without further notice).";
    }
